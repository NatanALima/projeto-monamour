...
function pesquisacep(valor) {
    ...
    if (cep != "") {
        ...
        if(validacep.test(cep)) {
            ...
            document.querySelector('.rua').value="Um momento...";
            document.querySelector('.bairro').value="Um momento...";
            document.querySelector('.cidade').value="Um momento...";
            document.querySelector('.uf').value="Um momento...";
